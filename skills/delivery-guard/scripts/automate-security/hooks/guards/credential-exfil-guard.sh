...
#   (Devin CLI). Detecção cobre sintaxe POSIX/bash e os equivalentes nativos
#   mais comuns do PowerShell (Get-ChildItem Env:, Get-Content, iwr/irm) —
#   ver README.md > "Limites conhecidos" para o que ainda não cobre.
